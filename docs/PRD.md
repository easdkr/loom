...
- xterm.js 패널이 전체 화면에 가깝게 확장되어 PTY 출력을 실시간으로 보여준다.
...
- 디자인 토큰, 컴포넌트 라이브러리, ReactFlow 에디터, xterm.js 패널, Plan Review, 단축키, 그래프 저장/불러오기, Auto 모드, 모드 전환
